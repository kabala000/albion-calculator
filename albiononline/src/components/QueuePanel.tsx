              ...
              >
                ...
                <div>
                  ...
                  {materialsComplete && job.status !== 'crafted_selling' && (
                    <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-lg text-center mb-4">
                      <p className="text-xs text-amber-200">
                        ¡Todos los requerimientos de materiales para este lote han sido completados con éxito!
                      </p>
                      <button
                        onClick={() => onCraftJob(job.id)}
                          ...
                          {unsoldQty <= 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-3">
                              ...
                              <div className="p-2.5 bg-black/40 rounded border border-gray-800 space-y-1 text-center">
                                ...
                                <button
                                  type="button"
                                  onClick={() => onPartialSellDirect(job.id, validPartialQty, adjustedSellPrice, directNetRevenue, directActualProfit)}
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="flex gap-1 w-full md:w-auto shrink-0 justify-end">
                                      <button
                                        type="button"
                                        onClick={() => onExecuteSellOrderList(job.id, list.id, list.quantity, list.price, listNetRevenue, listProfit)}
